...
private const val NOTIFICATION_ID = 235274 // Just a random number, no special meaning, must be unique

class NamedProcessService : Service() {
    ...
    private fun getNotification(): Notification {
        ...
        val description = "Process is running"
